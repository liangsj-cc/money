...
layui.use(['layer', 'form', 'table', 'ztree', 'laydate', 'admin', 'ax'], function () {
    ...
    MgrUser.initColumn = function () {
        return [[
            ...
            {field: 'examType', sort: true, title: '考试类型'},
            {field: 'examDate', sort: true, title: '未考试时间'},
    ...
    MgrUser.search = function () {
        ...
        queryData['beginTime'] = $("#timeLimit").val();
    ...
    $('#btnDowload').click(function () {
        window.location.href=Feng.ctxPath + "/exam_score/export";
    });

    // 渲染表格
    var tableResult = table.render({
        elem: '#' + MgrUser.tableId,
        url: Feng.ctxPath + '/exam_score/noexamlist',
        page: true,
        height: "full-98",
        cellMinWidth: 100,
