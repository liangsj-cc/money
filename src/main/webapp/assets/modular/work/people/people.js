layui.use(['layer', 'form', 'table', 'ztree', 'laydate', 'admin', 'ax'], function () {
    ...
    MgrUser.initColumn = function () {
        return [[
            ...
            {field: 'peopleSex', sort: true, title: '性别'},
    ...
    MgrUser.search = function () {
        ...
        queryData['peopleDept'] = $("#peopleDept").val();
        queryData['peopleType'] = $("#peopleType").val();
    ...
    MgrUser.InexportExcel = function () {
        ...
        top.layui.admin.open({
            type: 2,
            title: '批量导入人员',
            content: Feng.ctxPath + '/people/people_import',
            area: ['600px', '480px'],
            end: function () {
                admin.getTempData('formOk') && table.reload(MgrUser.tableId);
            }
